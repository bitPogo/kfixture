 ...
 */
public inline fun <reified T> PublicApi.Fixture.fixture(sign: PublicApi.Sign, size: Int, qualifier: PublicApi.Qualifier? = null, noinline predicate: Function1<T?, Boolean> = ::defaultPredicate): T where T : Number? {
