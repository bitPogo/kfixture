...
package gradle.kotlin.dsl.plugins._b33f5f82231a7bbc9c1eb5d918425ac3
...
/**
 * The `tech` plugin group.
 */
@org.gradle.api.Generated
internal
class `TechPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `tech`.
 */
internal
val `PluginDependenciesSpec`.`tech`: `TechPluginGroup`
    get() = `TechPluginGroup`(this)


/**
 * The `tech.antibytes` plugin group.
 */
@org.gradle.api.Generated
internal
class `TechAntibytesPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `tech.antibytes`.
 */
internal
val `TechPluginGroup`.`antibytes`: `TechAntibytesPluginGroup`
    get() = `TechAntibytesPluginGroup`(plugins)


/**
 * The `tech.antibytes.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `TechAntibytesGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `tech.antibytes.gradle`.
 */
internal
val `TechAntibytesPluginGroup`.`gradle`: `TechAntibytesGradlePluginGroup`
    get() = `TechAntibytesGradlePluginGroup`(plugins)


/**
 * The `tech.antibytes.gradle.configuration` plugin implemented by [tech.antibytes.gradle.configuration.AntiBytesConfiguration].
 */
internal
val `TechAntibytesGradlePluginGroup`.`configuration`: PluginDependencySpec
    get() = plugins.id("tech.antibytes.gradle.configuration")


/**
 * The `tech.antibytes.gradle.coverage` plugin implemented by [tech.antibytes.gradle.coverage.AntiBytesCoverage].
 */
internal
val `TechAntibytesGradlePluginGroup`.`coverage`: PluginDependencySpec
    get() = plugins.id("tech.antibytes.gradle.coverage")


/**
 * The `tech.antibytes.gradle.dependency` plugin implemented by [tech.antibytes.gradle.dependency.AntiBytesDependency].
 */
internal
val `TechAntibytesGradlePluginGroup`.`dependency`: PluginDependencySpec
    get() = plugins.id("tech.antibytes.gradle.dependency")


/**
 * The `tech.antibytes.gradle.publishing` plugin implemented by [tech.antibytes.gradle.publishing.AntiBytesPublishing].
 */
internal
val `TechAntibytesGradlePluginGroup`.`publishing`: PluginDependencySpec
    get() = plugins.id("tech.antibytes.gradle.publishing")
