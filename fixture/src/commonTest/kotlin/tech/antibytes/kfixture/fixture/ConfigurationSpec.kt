...
import tech.antibytes.kfixture.Configuration
import tech.antibytes.kfixture.FixtureContract
import tech.antibytes.kfixture.PublicApi
import tech.antibytes.kfixture.fixture.mock.GeneratorFactoryStub
...
class ConfigurationSpec {
    ...
    fun `Given addGenerator is called with a Klass and a GeneratorFactory it adds the a custom Generator`() {
        ...
        assertTrue(
            generators.containsKey("tech.antibytes.kfixture.fixture.TestClass") || generators.containsKey("TestClass"),
            message = "Missing Key (tech.antibytes.kfixture.fixture.TestClass)"
        )
        assertTrue(
            generators["tech.antibytes.kfixture.fixture.TestClass"] is TestGenerator ||
    ...
    fun `Given addGenerator is called with a Klass a GeneratorFactory and a Qualifier it prevents overriding buildins`() {
        ...
        val generators = fixture.generators
        assertTrue(
            generators.containsKey("q:$qualifier:tech.antibytes.kfixture.fixture.TestClass") ||
                generators.containsKey("q:$qualifier:TestClass"),
            message = "Missing Key (q:$qualifier:tech.antibytes.kfixture.fixture.TestClass)"
        )
        assertTrue(
            generators["q:$qualifier:tech.antibytes.kfixture.fixture.TestClass"] is TestGenerator ||
