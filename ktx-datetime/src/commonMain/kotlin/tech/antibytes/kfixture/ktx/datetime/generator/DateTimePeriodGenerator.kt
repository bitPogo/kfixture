    ...
    companion object : PublicApi.DependentGeneratorFactory<DateTimePeriod> {
        ...
        override fun getInstance(
            ...
            return DateTimePeriodGenerator(
                microTimeGenerator = generators[macroId] as PublicApi.RangedGenerator<Long, Long>,
                macroTimeGenerator = generators[microId] as PublicApi.RangedGenerator<Int, Int>,
            )
        }
    }
}
