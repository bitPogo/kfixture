...
class LocalDateGeneratorSpec {
    ...
    fun `It fulfils DependentGenerator`() {
        val generator: Any = LocalDateGenerator
    ...
    fun `It fulfils Generator`() {
        ...
        val generator: Any = LocalDateGenerator.getInstance(
            RandomStub(),
            mapOf(
    ...
    fun `Given generate is called it returns a LocalDateTime`() {
        ...
        assertEquals(
            actual = actual,
            expected = expectedInstant.toLocalDateTime(expectedTimeZone).date,
        )
