...
class ConfigurationStub(
    ...
    var addDependentGenerator: ((KClass<*>, PublicApi.DependentGeneratorFactory<*>, PublicApi.Qualifier?) -> Unit)? = null,
    ...
    override fun <T : Any> addGenerator(
        ...
        addDependentGenerator?.invoke(clazz as KClass<*>, factory as PublicApi.DependentGeneratorFactory<*>, qualifier)
            ?: throw IllegalArgumentException("Missing SideEffect addGenerator")
